...
/**
 ...
 $Header: /textus/auxiliary/Auxi.cpp 22    12-04-04 16:51 Octerboy $
*/

#define SCM_MODULE_ID  "$Workfile: Auxi.cpp $"
#define TEXTUS_MODTIME  "$Date: 12-04-04 16:51 $"
#define TEXTUS_BUILDNO  "$Revision: 22 $"
/* $NoKeywords: $ */
