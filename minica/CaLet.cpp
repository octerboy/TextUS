...
/**
 ...
 $Header: /textus/tsoap/CaLet.cpp 15    07-01-14 14:34 Octerboy $
*/

#define SCM_MODULE_ID  "$Workfile: CaLet.cpp $"
#define TEXTUS_MODTIME  "$Date: 07-01-14 14:34 $"
#define TEXTUS_BUILDNO  "$Revision: 15 $"
/* $NoKeywords: $ */
