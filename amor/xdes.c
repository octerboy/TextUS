...
int	Rota[16] = {	/* Standard */
		1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1
	};

int	Rotb[16] = {	/* User defined */
		1, 2, 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2
	};

static void transpose( int data[], int tr[], int n)
{
	int	i, k;
	int	temp[64];
...
static void rotateleft( int key[] )
{
	int	i, aa;
...
static void rotateright( int key[] )
{
	int	i, aa;
...
static void fm( int func, int i, int key[], int a [], int x[] )
{
...
static void xdes( int plaintext[], int key[], int ciphertext[], int func, int flag )
/* func==-1: decryption
   func== 1: encryption
   flag== 0: standard
   flag== 1: user_defined
